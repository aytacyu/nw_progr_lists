...
my_ipaddr = ['192.168.1.1', '10.1.1.1', '172.16.31.254', '8.8.8.8', '8.8.4.4']
my_ipaddr.append('10.10.10.10')
my_ipaddr.extend(['1.1.1.1', '1.1.1.2'])
my_ipaddr = my_ipaddr + ['172.16.1.1', '172.16.1.2']
print(my_ipaddr)

print(my_ipaddr[0])
print(my_ipaddr[-1])

first_ip = my_ipaddr.pop(0)
last_ip = my_ipaddr.pop()
